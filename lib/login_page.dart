                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                      children:[
                        Text("Hello",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 70),),
                        ...
                        Row(
                          children: [
                            ...
                            Text("forgot password?",style: TextStyle(fontSize: 20,color: Colors.grey[500]),),
                        ...
                        Center(
                          child: Container(
                            ...
                            child:
                            Center(child: Text("Sign in",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 36,color: Colors.white),)),
